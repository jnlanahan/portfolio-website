...
const HomePage = () => {
  ...
  return (
    <div className="min-h-screen">
      {/* Lamp Component */}
      <LampContainer className="min-h-[60vh] bg-gradient-to-b from-slate-950 to-slate-900">
        <motion.div
        ...
        >
          <h1 
            className="bg-gradient-to-br from-slate-300 to-slate-500 bg-clip-text text-transparent text-4xl md:text-7xl font-medium tracking-tight"
            style={{ 
              fontFamily: 'Work Sans, -apple-system, BlinkMacSystemFont, sans-serif',
            }}
          >
            Portfolio <br /> Illuminated
          </h1>
        </motion.div>
      </LampContainer>
