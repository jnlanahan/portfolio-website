      ...
      <DialogContent className="sm:max-w-[500px] bg-white border-gray-200">
        ...
        <div className="space-y-4 py-4">
          <p className="text-gray-700 leading-relaxed">
            As a Product Manager, I'm always looking for ways to improve this product. While I don't know who you are and don't collect personal details outside of the contact form, I do use product analytics (via PostHog) to see how the site is used and review chatbot conversations (via LangSmith) to enhance the experience. Performance metrics and usage patterns are also collected to optimize the user experience.
          </p>
