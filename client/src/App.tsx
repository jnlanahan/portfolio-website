...
import AdminSetupSecurityPage from "@/pages/AdminSetupSecurityPage";
...
function Router() {
  return (
    <Switch>
      ...
      <Route path="/admin/recovery/verify" component={AdminRecoveryPage} />
      <Route path="/admin/setup-security" component={AdminSetupSecurityPage} />
